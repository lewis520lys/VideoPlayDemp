...
import com.lewis.player.demo.DemoProcessHomeKeyFragenment;
...
public class MyFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    List<DemoProcessHomeKeyFragenment> list;//需要显示的fragment在构造器中传入
    List<String> titleList;

    public MyFragmentPagerAdapter(FragmentManager fm, List<DemoProcessHomeKeyFragenment> list, List<String> titleList) {
